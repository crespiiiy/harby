 ...
 * by third-party libraries. It uses a Proxy to intercept any access to window
 * properties and automatically creates constructors as needed.
 */
...
(function() {
  ...
  // Pre-define common constructors
  const commonConstructors = ['He', 'We', 'Vue', 'Vm', 'Component'];
